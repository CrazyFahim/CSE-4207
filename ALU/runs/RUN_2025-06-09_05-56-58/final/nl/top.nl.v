module top (clk,
 ...
 sky130_fd_sc_hd__clkbuf_1 _18_ (.A(_07_),
    .X(net7));
 sky130_fd_sc_hd__nor2_1 _19_ (.A(net11),
    .B(net10),
    .Y(\fsm.nstate[0] ));
 sky130_fd_sc_hd__xnor2_1 _20_ (.A(\fsm.pstate[0] ),
    .B(\fsm.pstate[1] ),
    .Y(_08_));
 sky130_fd_sc_hd__nor2_1 _21_ (.A(net10),
    .B(_08_),
    .Y(\fsm.nstate[1] ));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(\fsm.pstate[2] ),
    .X(net10));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\fsm.pstate[0] ),
    .X(net11));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_3_60 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_5_61 ();
 sky130_ef_sc_hd__decap_12 FILLER_6_13 ();

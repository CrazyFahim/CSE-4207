...
set ::env(CURRENT_DEF) /foss/designs/ALU/runs/RUN_2025-06-08_17-25-06/52-odb-cellfrequencytables/ALU_7bit.def
...
set ::env(SAVE_SPEF) /foss/designs/ALU/runs/RUN_2025-06-08_17-25-06/53-openroad-rcx/max/ALU_7bit.max.spef

...
set ::env(PL_TARGET_DENSITY_PCT) 80.0
set ::env(PL_SKIP_INITIAL_PLACEMENT) 0
set ::env(PL_WIRE_LENGTH_COEF) 0.25
set ::env(FP_CORE_UTIL) 70
set ::env(GPL_CELL_PADDING) 0
set ::env(FP_PPL_MODE) matching
set ::env(CURRENT_ODB) /foss/designs/ALU/runs/RUN_2025-06-08_17-25-06/20-openroad-generatepdn/ALU_7bit.odb
set ::env(SAVE_ODB) /foss/designs/ALU/runs/RUN_2025-06-08_17-25-06/23-openroad-globalplacementskipio/ALU_7bit.odb
set ::env(SAVE_DEF) /foss/designs/ALU/runs/RUN_2025-06-08_17-25-06/23-openroad-globalplacementskipio/ALU_7bit.def
set ::env(SAVE_SDC) /foss/designs/ALU/runs/RUN_2025-06-08_17-25-06/23-openroad-globalplacementskipio/ALU_7bit.sdc
set ::env(SAVE_NETLIST) /foss/designs/ALU/runs/RUN_2025-06-08_17-25-06/23-openroad-globalplacementskipio/ALU_7bit.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/ALU/runs/RUN_2025-06-08_17-25-06/23-openroad-globalplacementskipio/ALU_7bit.pnl.v

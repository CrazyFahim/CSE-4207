module top (clk,
 ...
 sky130_fd_sc_hd__xnor2_1 _09_ (.A(\controller_inst.pstate[1] ),
    ...
    .VPWR(VPWR),
    .Y(net7));
 sky130_fd_sc_hd__inv_2 _10_ (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\controller_inst.nstate[0] ));
 sky130_fd_sc_hd__xor2_1 _11_ (.A(net11),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _13_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__dfrtp_4 _14_ (.CLK(clknet_1_0__leaf_clk),
 ...
 sky130_fd_sc_hd__dfrtp_2 _15_ (.CLK(clknet_1_1__leaf_clk),
 ...
 sky130_fd_sc_hd__conb_1 top_9 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net9));
 ...
 sky130_fd_sc_hd__buf_2 output7 (.A(net7),
    ...
    .VPWR(VPWR),
    .X(result[6]));
 sky130_fd_sc_hd__conb_1 top_8 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net8));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(\controller_inst.pstate[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\controller_inst.pstate[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
